...
def load_CIRCD1_data(prefix='data/preprocessed/CIRCD1_processed'):
    in_file = open(prefix + '/0/0-1-0.adjlist', 'r')
    adjlist00 = [line.strip() for line in in_file]
    adjlist00 = adjlist00
    in_file.close()
...
def load_CIRCD2_data(prefix='data/preprocessed/CIRCD2_processed'):
    in_file = open(prefix + '/0/0-1-0.adjlist', 'r')
    adjlist00 = [line.strip() for line in in_file]
    adjlist00 = adjlist00
    in_file.close()
...
def load_CIRDM3_data(prefix='data/preprocessed/CIRDM3_processed'):
    in_file = open(prefix + '/0/0-1-0.adjlist', 'r')
    adjlist00 = [line.strip() for line in in_file]
    adjlist00 = adjlist00
    in_file.close()
    ...
    return [[adjlist00, adjlist01, adjlist02],[adjlist10, adjlist11]],\
           [[idx00, idx01, idx02], [idx10, idx11]],\
           adjM, type_mask, train_val_test_pos_circrna_disease, train_val_test_neg_circrna_disease

def load_LNCD_data(prefix='data/preprocessed/LNCD_processed'):
    in_file = open(prefix + '/0/0-1-0.adjlist', 'r')
    adjlist00 = [line.strip() for line in in_file]
    adjlist00 = adjlist00
    in_file.close()
    ...
    adjM = scipy.sparse.load_npz(prefix + '/adjM.npz')
    type_mask = np.load(prefix + '/node_types.npy')
    train_val_test_pos_lncrna_disease = np.load(prefix + '/train_val_test_pos_lncrna_disease.npz')
    train_val_test_neg_lncrna_disease = np.load(prefix + '/train_val_test_neg_lncrna_disease.npz')

    return [[adjlist00,adjlist01,adjlist02], [adjlist10,adjlist11]], \
           [[idx00,idx01,idx02], [idx10,idx11]], \
           adjM, type_mask, train_val_test_pos_lncrna_disease, train_val_test_neg_lncrna_disease

def load_CIRDM3_gene_data(prefix='data/preprocessed/CIRDM3_gene_processed'):
    in_file = open(prefix + '/0/0-1-0.adjlist', 'r')
    adjlist00 = [line.strip() for line in in_file]
    adjlist00 = adjlist00
    in_file.close()
    ...
    adjlist02 = [line.strip() for line in in_file]
    adjlist02 = adjlist02
    in_file = open(prefix + '/0/0-2-3-2-0.adjlist', 'r')
    ...
    adjlist12 = adjlist12
    in_file.close()
    in_file = open(prefix + '/1/1-3-1.adjlist', 'r')
    ...
    idx02 = pickle.load(in_file)
    in_file.close()
    in_file = open(prefix + '/0/0-2-3-2-0_idx.pickle', 'rb')
    ...
    return [[adjlist00, adjlist01, adjlist02, adjlist03],[adjlist10, adjlist11, adjlist12, adjlist13]],\
           [[idx00, idx01, idx02, idx03], [idx10, idx11, idx12, idx13]],\
           adjM, type_mask, train_val_test_pos_circrna_disease, train_val_test_neg_circrna_disease
